...
function Contact() {
      return (
        <Container className="my-5">
              <h2 className="text-center fw-bold mb-2">Contact</h2>
          ...
          <Row className="shadow rounded p-4 bg-white mt-5">
            ...
            <Col md={6} className="mb-4 mb-md-0">
              <h3 className="fw-bold border-bottom border-primary border-3 mb-5">Formulaire de contact</h3>
              <Form>
                <Form.Control className="mb-2" type="text" placeholder="Votre nom" />
                <Form.Control className="mb-2" type="email" placeholder="Votre adresse email" />
                <Form.Control className="mb-2" type="tel" placeholder="Votre numéro de téléphone" />
                <Form.Control className="mb-2" type="text" placeholder="Sujet" />
                <Form.Control className="mb-3" as="textarea" rows={5} placeholder="Votre message" style={{ height: '500px' }} />
            ...
            {/* Coordonnées */}
            <Col md={6}>
              <h3 className="fw-bold border-bottom border-primary border-3 mb-5">Mes coordonnées</h3>
